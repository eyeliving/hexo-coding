---
title: JSONP的原理，JSON和JSONP区别，也许你会豁然开朗，含jQuery用例
description: JSONP的原理，JSON和JSONP区别，也许你会豁然开朗，含jQuery用例
keywords: JSONP的原理，JSON和JSONP区别
date: 2016-11-30 17:21
tags: javascript
---
> 前言
...
哈哈，这就是jQuery的功劳了，jquery在处理jsonp类型的ajax时（还是忍不住吐槽，虽然jquery也把jsonp归入了ajax，但其实它们真的不是一回事儿），自动帮你生成回调函数并把数据取出来供success属性方法来调用，是不是很爽呀？
...
-摘自于  [cnblogs](http://www.cnblogs.com/dowinning/archive/2012/04/19/json-jsonp-jquery.html "cnblogs")
